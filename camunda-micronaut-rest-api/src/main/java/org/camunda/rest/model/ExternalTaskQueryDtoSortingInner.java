 ...
 */
@JsonPropertyOrder({
  ExternalTaskQueryDtoSortingInner.JSON_PROPERTY_SORT_BY,
  ExternalTaskQueryDtoSortingInner.JSON_PROPERTY_SORT_ORDER
})
...
public class ExternalTaskQueryDtoSortingInner {
    ...
    public ExternalTaskQueryDtoSortingInner() {
    }
